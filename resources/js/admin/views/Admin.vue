                                                ...
                                                >
                                                    <v-card-text>
                                                        ...
                                                        <v-text-field v-validate="'required'"
                                                                      ...
                                                                      label="Email"
                                                        ></v-text-field>
                                                        <v-text-field :error-messages="errors.collect('password')"
...
export default {
    ...
    methods: {
        initialize() {
            ...
            axios.get('/adminAPI/users' + '?page=' + this.pagination.current)
                .then(function (resp) {
                ...
                .then(responses => {
                    if (responses) {
                        if (this.editedIndex > -1) {
                            ...
                            axios.post('/adminAPI/users/update/' + newItem.id, newItem)
                                .then(function (resp) {
                                    Swal.fire({
                                        type: 'success',
                                        title: 'Success!',
                            ...
                            axios.post('/adminAPI/users/add', newItem).then((resp) => {
                                Swal.fire({
                                    type: 'success',
                                    title: 'Success!',
                                    text: resp.data.message,
