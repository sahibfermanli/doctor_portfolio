...
export default {
    ...
    methods: {
        initialize() {
            ...
            axios.get('/adminAPI/categories' + '?page=' + this.pagination.current)
                .then(function (resp) {
                ...
                .then(responses => {
                    if (responses) {
                        if (this.editedIndex > -1) {
                            ...
                            axios.post('/adminAPI/categories/update/' + newItem.id, newItem)
                                .then(function (resp) {
                                    Swal.fire({
                                        type: 'success',
                                        title: 'Success!',
                            ...
                            axios.post('/adminAPI/categories/add/', newItem).then((resp) => {
                                Swal.fire({
                                    type: 'success',
                                    title: 'Success!',
                                    text: resp.data.message,
